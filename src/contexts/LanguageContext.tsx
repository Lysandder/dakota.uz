...
const translations: Record<Language, Record<string, string>> = {
  ru: {
    ...
    'footer.owner': 'Sofa Master',
    'admin.login': 'Вход в панель управления',
    'admin.password': 'Пароль',
    'admin.enter': 'Войти',
    'admin.error': 'Неверный пароль',
    'admin.coming_soon.title': 'Скоро',
    'admin.coming_soon.desc': 'Раздел в разработке.',
    'admin.demo_note': 'Панель управления в разработке — скоро появятся действия.',
  ...
  uz: {
    ...
    'admin.coming_soon.title': 'Tez kunda',
    'admin.coming_soon.desc': "Bo'lim ishlab chiqilmoqda.",
    'admin.demo_note': "Boshqaruv paneli ishlab chiqilmoqda — tez orada funksiyalar qo'shiladi.",
